...
Begin VB.Form frmGEOPosition 
   ...
   Begin VB.TextBox txtSexagesimal 
      BackColor       =   &H8000000F&
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   7.8
   ...
   Begin VB.TextBox txtCenter 
      ...
      Width           =   2772
   End
   Begin VB.TextBox txtMouseLatLng 
      BackColor       =   &H8000000F&
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   7.8
      ...
      Width           =   2772
   End
   Begin Diashow_MS.ucGMap ucGMap1 
      Height          =   7680
      Left            =   480
      TabIndex        =   4
      Top             =   0
   ...
   Begin VB.Image imgMinus 
      Height          =   432
      Left            =   0
      Picture         =   "frmGEOPosition.frx":0000
      Stretch         =   -1  'True
      Top             =   1200
      Width           =   432
   End
...
'    ucGMap1.Height = 640 * Screen.TwipsPerPixelY
'    ucGMap1.Width = 640 * Screen.TwipsPerPixelX
    ...
    txtMouseLatLng.Text = "Mouse: " & ""
    txtSexagesimal.Text = ListBoxForm.GPSLatitudeRef & " " & ListBoxForm.GPSLatitude & " , " & ListBoxForm.GPSLongitudeRef & " " & ListBoxForm.GPSLongitude
End Sub
...
Private Sub ucGMap1_DblClick(ByVal GMouseCoordLatLng As String)
    ucGMap1.GPoint = Mid$(GMouseCoordLatLng, 1)                         'Gerbing 02.09.2016
End Sub

Private Sub ucGMap1_MouseMove(ByVal GMouseCoordLatLng As String)
    txtMouseLatLng.Text = "Mouse: " & GMouseCoordLatLng
End Sub

...
'    Call WriteSLF(txtStandortFotos.Text)    'Schreibe [SQL] LocationFotos
    ...
    On Error Resume Next
    strTemp = ""
    If file_path_exist(strSchlüssel) = False Then                               'Gerbing 04.03.2013
        'MsgBox txtStandortFotos.Text & " " & "Ordner existiert nicht"
        'MsgBox lblStandortFotos.Caption & "='" & txtStandortFotos.Text & "' " & LoadResString(1838 + Sprache)
        MsgBox strSchlüssel & " " & LoadResString(1838 + Sprache)
        End
    End If

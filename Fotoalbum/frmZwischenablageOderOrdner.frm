...
Private Sub optOrdner_Click()
    ClipboardCopyFiles (gstrFRODN)
End Sub

Private Sub optZwischenablage_Click()
    'Picture1.Picture = LoadPicture(gstrFRODN)                  'versteht nicht unicode
    Call LoadPictureWThumb(gstrFRODN)                           'versteht unicode Gerbing 11.08.2017
    Clipboard.Clear
    ...
    If OpenClipboard(0&) Then
        ...
        If hGlobal Then
            ...
            If SetClipboardData(CF_HDROP, hGlobal) Then
                'If SetClipboardData(CF_UNICODETEXT, hGlobal) Then
                ClipboardCopyFiles = True
            End If
            If SetClipboardData(CF_UNICODETEXT, hGlobal) Then                           'Gerbing 13.01.2019
                ClipboardCopyFiles = True
            End If
        End If
        ' Clean up
